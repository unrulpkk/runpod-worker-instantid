...
if [ -f "/workspace/venv/bin/activate" ]; then
    ...
    echo "1. Ensure that you have followed the instructions at: https://github.com/ashleykleynhans/runpod-worker-a1111/blob/main/docs/building/with-network-volume.md"
